...
#dates.remove("2015_10_07.txt")
#dates.remove("2017_09_07.txt")
dates.remove("2001_03_31.txt")
...
for iii in range(len(dates)):
    ...
    #################################
    # try auto spline instead
    GCV_auto = GCVSmoothedNSpline(x2, y2)
    x3 = np.linspace(x2[0], x2[-1], 1000)
    y3 = GCV_auto(x3)
